...
.. "examples_gallery/statistical_plots/plot_correlation_matrix.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_gallery_statistical_plots_plot_correlation_matrix.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_gallery_statistical_plots_plot_correlation_matrix.py:
...
.. image-sg:: /examples_gallery/statistical_plots/images/sphx_glr_plot_correlation_matrix_001.png
   :alt: Correlation Matrix, Strong Positive (r=0.79), Weak Positive (r=0.22), Negative (r=-0.42)
   :srcset: /examples_gallery/statistical_plots/images/sphx_glr_plot_correlation_matrix_001.png
