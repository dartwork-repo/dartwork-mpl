...
.. "examples_gallery/statistical_plots/plot_histogram.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_gallery_statistical_plots_plot_histogram.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_gallery_statistical_plots_plot_histogram.py:
...
.. image-sg:: /examples_gallery/statistical_plots/images/sphx_glr_plot_histogram_001.png
   :alt: Basic Histogram, Stacked Histogram, Histogram with KDE, Overlaid Histograms
   :srcset: /examples_gallery/statistical_plots/images/sphx_glr_plot_histogram_001.png
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_histogram.ipynb <plot_histogram.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_histogram.py <plot_histogram.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_histogram.zip <plot_histogram.zip>`
