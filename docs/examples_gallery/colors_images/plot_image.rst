...
.. "examples_gallery/colors_images/plot_image.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_gallery_colors_images_plot_image.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_gallery_colors_images_plot_image.py:
...
.. image-sg:: /examples_gallery/colors_images/images/sphx_glr_plot_image_001.png
   :alt: Colormap: Spectral, Colormap: Coolwarm, Colormap: Viridis, Edge Map Overlay
   :srcset: /examples_gallery/colors_images/images/sphx_glr_plot_image_001.png
