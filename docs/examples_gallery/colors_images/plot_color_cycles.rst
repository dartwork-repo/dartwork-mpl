...
.. "examples_gallery/colors_images/plot_color_cycles.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_gallery_colors_images_plot_color_cycles.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_gallery_colors_images_plot_color_cycles.py:
...
.. image-sg:: /examples_gallery/colors_images/images/sphx_glr_plot_color_cycles_001.png
   :alt: Default Color Cycle, Blue Gradient Cycle, Tailwind Color Cycle, Combined Cycle (Color × Style)
   :srcset: /examples_gallery/colors_images/images/sphx_glr_plot_color_cycles_001.png
