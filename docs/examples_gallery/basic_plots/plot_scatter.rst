...
.. "examples_gallery/basic_plots/plot_scatter.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_gallery_basic_plots_plot_scatter.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_gallery_basic_plots_plot_scatter.py:
...
.. image-sg:: /examples_gallery/basic_plots/images/sphx_glr_plot_scatter_001.png
   :alt: Basic Scatter Plot, Color Mapping, Size Mapping, Density + Scatter Overlay
   :srcset: /examples_gallery/basic_plots/images/sphx_glr_plot_scatter_001.png
