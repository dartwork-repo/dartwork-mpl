...
.. "examples_gallery/basic_plots/plot_basic.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_gallery_basic_plots_plot_basic.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_gallery_basic_plots_plot_basic.py:
...
.. image-sg:: /examples_gallery/basic_plots/images/sphx_glr_plot_basic_001.png
   :alt: Styled Signal with dartwork-mpl
   :srcset: /examples_gallery/basic_plots/images/sphx_glr_plot_basic_001.png
