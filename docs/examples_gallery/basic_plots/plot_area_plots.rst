...
.. "examples_gallery/basic_plots/plot_area_plots.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_gallery_basic_plots_plot_area_plots.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_gallery_basic_plots_plot_area_plots.py:
...
.. image-sg:: /examples_gallery/basic_plots/images/sphx_glr_plot_area_plots_001.png
   :alt: Basic Fill Between, Confidence Interval, Overlapping Areas, Stacked Areas
   :srcset: /examples_gallery/basic_plots/images/sphx_glr_plot_area_plots_001.png
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_area_plots.ipynb <plot_area_plots.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_area_plots.py <plot_area_plots.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_area_plots.zip <plot_area_plots.zip>`
