...
.. "examples_gallery/layout_styling/plot_subplots.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_gallery_layout_styling_plot_subplots.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_gallery_layout_styling_plot_subplots.py:
...
.. image-sg:: /examples_gallery/layout_styling/images/sphx_glr_plot_subplots_001.png
   :alt: Subplot 1, Subplot 2, Subplot 3, Subplot 4
   :srcset: /examples_gallery/layout_styling/images/sphx_glr_plot_subplots_001.png
