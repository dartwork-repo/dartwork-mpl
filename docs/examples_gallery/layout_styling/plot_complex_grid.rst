...
.. "examples_gallery/layout_styling/plot_complex_grid.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_gallery_layout_styling_plot_complex_grid.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_gallery_layout_styling_plot_complex_grid.py:
...
.. image-sg:: /examples_gallery/layout_styling/images/sphx_glr_plot_complex_grid_001.png
   :alt: Main Plot (2x2), Scatter, Histogram, Bar, Box, Polar-like
   :srcset: /examples_gallery/layout_styling/images/sphx_glr_plot_complex_grid_001.png
