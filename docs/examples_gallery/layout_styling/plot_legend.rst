...
.. "examples_gallery/layout_styling/plot_legend.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_gallery_layout_styling_plot_legend.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_gallery_layout_styling_plot_legend.py:
...
.. image-sg:: /examples_gallery/layout_styling/images/sphx_glr_plot_legend_001.png
   :alt: Legend: Auto Placement, Custom Legend Handles, Legend: Auto (Compact), Categorical Legend
   :srcset: /examples_gallery/layout_styling/images/sphx_glr_plot_legend_001.png
