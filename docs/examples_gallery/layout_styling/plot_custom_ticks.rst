...
.. "examples_gallery/layout_styling/plot_custom_ticks.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_gallery_layout_styling_plot_custom_ticks.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_gallery_layout_styling_plot_custom_ticks.py:
...
.. image-sg:: /examples_gallery/layout_styling/images/sphx_glr_plot_custom_ticks_001.png
   :alt: Custom Tick Positions, Custom Tick Labels, Log Scale Ticks, Percent & Minor Ticks
   :srcset: /examples_gallery/layout_styling/images/sphx_glr_plot_custom_ticks_001.png
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_custom_ticks.ipynb <plot_custom_ticks.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_custom_ticks.py <plot_custom_ticks.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_custom_ticks.zip <plot_custom_ticks.zip>`
