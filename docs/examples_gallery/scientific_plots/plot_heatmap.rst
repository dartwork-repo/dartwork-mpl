...
.. "examples_gallery/scientific_plots/plot_heatmap.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_gallery_scientific_plots_plot_heatmap.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_gallery_scientific_plots_plot_heatmap.py:
...
.. image-sg:: /examples_gallery/scientific_plots/images/sphx_glr_plot_heatmap_001.png
   :alt: Random Field (Diverging), Feature Correlation Matrix
   :srcset: /examples_gallery/scientific_plots/images/sphx_glr_plot_heatmap_001.png
