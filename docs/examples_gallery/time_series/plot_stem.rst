...
.. "examples_gallery/time_series/plot_stem.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_gallery_time_series_plot_stem.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_gallery_time_series_plot_stem.py:
...
.. image-sg:: /examples_gallery/time_series/images/sphx_glr_plot_stem_001.png
   :alt: Basic Stem Plot, Stem with Markers, Multiple Stem Series, Categorical Stem Plot
   :srcset: /examples_gallery/time_series/images/sphx_glr_plot_stem_001.png
