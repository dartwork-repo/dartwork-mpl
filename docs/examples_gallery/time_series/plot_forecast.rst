...
.. "examples_gallery/time_series/plot_forecast.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_gallery_time_series_plot_forecast.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_gallery_time_series_plot_forecast.py:
...
.. image-sg:: /examples_gallery/time_series/images/sphx_glr_plot_forecast_001.png
   :alt: Forecast with CI, Decomposition, Residual Analysis, Forecast Scenarios
   :srcset: /examples_gallery/time_series/images/sphx_glr_plot_forecast_001.png
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-zip
      ...
      :download:`Download zipped: plot_forecast.zip <plot_forecast.zip>`
