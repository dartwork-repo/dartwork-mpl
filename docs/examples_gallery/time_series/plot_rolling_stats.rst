...
.. "examples_gallery/time_series/plot_rolling_stats.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_gallery_time_series_plot_rolling_stats.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_gallery_time_series_plot_rolling_stats.py:
...
.. image-sg:: /examples_gallery/time_series/images/sphx_glr_plot_rolling_stats_001.png
   :alt: Moving Averages, Rolling Standard Deviation, Exponential Moving Average, Bollinger Bands
   :srcset: /examples_gallery/time_series/images/sphx_glr_plot_rolling_stats_001.png
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_rolling_stats.ipynb <plot_rolling_stats.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_rolling_stats.py <plot_rolling_stats.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_rolling_stats.zip <plot_rolling_stats.zip>`
