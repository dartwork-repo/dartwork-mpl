...
.. "examples_gallery/specialized_plots/plot_pie.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_gallery_specialized_plots_plot_pie.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_gallery_specialized_plots_plot_pie.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 7-142



.. image-sg:: /examples_gallery/specialized_plots/images/sphx_glr_plot_pie_001.png
   :alt: Basic Pie Chart, Donut Chart, Exploded Pie Chart, Nested Donut Variations
   :srcset: /examples_gallery/specialized_plots/images/sphx_glr_plot_pie_001.png
