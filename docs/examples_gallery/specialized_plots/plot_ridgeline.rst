...
.. "examples_gallery/specialized_plots/plot_ridgeline.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_gallery_specialized_plots_plot_ridgeline.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_gallery_specialized_plots_plot_ridgeline.py:
...
.. image-sg:: /examples_gallery/specialized_plots/images/sphx_glr_plot_ridgeline_001.png
   :alt: Basic Ridgeline, Colored Ridgeline, With Data Points, Overlapping Style
   :srcset: /examples_gallery/specialized_plots/images/sphx_glr_plot_ridgeline_001.png
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_ridgeline.ipynb <plot_ridgeline.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_ridgeline.py <plot_ridgeline.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_ridgeline.zip <plot_ridgeline.zip>`
