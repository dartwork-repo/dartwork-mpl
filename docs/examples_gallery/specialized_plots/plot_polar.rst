...
.. "examples_gallery/specialized_plots/plot_polar.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_gallery_specialized_plots_plot_polar.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_gallery_specialized_plots_plot_polar.py:
...
.. image-sg:: /examples_gallery/specialized_plots/images/sphx_glr_plot_polar_001.png
   :alt: Basic Polar Plot, Polar Scatter Plot, Polar Bar Chart, Radial Multi-Series
   :srcset: /examples_gallery/specialized_plots/images/sphx_glr_plot_polar_001.png
