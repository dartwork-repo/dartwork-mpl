...
.. "examples_gallery/specialized_plots/plot_3d.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_gallery_specialized_plots_plot_3d.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_gallery_specialized_plots_plot_3d.py:
...
.. image-sg:: /examples_gallery/specialized_plots/images/sphx_glr_plot_3d_001.png
   :alt: 3D Surface Plot
   :srcset: /examples_gallery/specialized_plots/images/sphx_glr_plot_3d_001.png
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /home/wonjun/Codes/dartwork-mpl/docs/examples_source/specialized_plots/plot_3d.py:43: UserWarning: This figure includes Axes that are not compatible with tight_layout, so results might be incorrect.
      plt.tight_layout()
