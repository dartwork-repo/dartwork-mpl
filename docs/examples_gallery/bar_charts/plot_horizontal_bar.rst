...
.. "examples_gallery/bar_charts/plot_horizontal_bar.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_gallery_bar_charts_plot_horizontal_bar.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_gallery_bar_charts_plot_horizontal_bar.py:
...
.. image-sg:: /examples_gallery/bar_charts/images/sphx_glr_plot_horizontal_bar_001.png
   :alt: Basic Horizontal Bar, Sorted Horizontal Bar, Grouped Horizontal Bars, With Value Labels
   :srcset: /examples_gallery/bar_charts/images/sphx_glr_plot_horizontal_bar_001.png
