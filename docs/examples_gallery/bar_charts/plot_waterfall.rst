...
.. "examples_gallery/bar_charts/plot_waterfall.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_gallery_bar_charts_plot_waterfall.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_gallery_bar_charts_plot_waterfall.py:
...
.. image-sg:: /examples_gallery/bar_charts/images/sphx_glr_plot_waterfall_001.png
   :alt: Basic Waterfall, With Connecting Lines, With Value Labels, Detailed Breakdown
   :srcset: /examples_gallery/bar_charts/images/sphx_glr_plot_waterfall_001.png
