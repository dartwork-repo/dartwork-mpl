...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_plot_polar.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_plot_polar.py:
...
.. image-sg:: /gallery/images/sphx_glr_plot_polar_001.png
   :alt: Basic Polar Plot, Polar Scatter Plot, Polar Bar Chart
   :srcset: /gallery/images/sphx_glr_plot_polar_001.png
