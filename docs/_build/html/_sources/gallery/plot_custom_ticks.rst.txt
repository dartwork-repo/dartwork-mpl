...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_plot_custom_ticks.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_plot_custom_ticks.py:
...
.. image-sg:: /gallery/images/sphx_glr_plot_custom_ticks_001.png
   :alt: Custom Tick Positions, Custom Tick Labels, Log Scale Ticks
   :srcset: /gallery/images/sphx_glr_plot_custom_ticks_001.png
