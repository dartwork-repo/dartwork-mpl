...
.. "gallery/08_colors_images/plot_colors.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_08_colors_images_plot_colors.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_08_colors_images_plot_colors.py:
...
.. image-sg:: /gallery/08_colors_images/images/sphx_glr_plot_colors_001.png
   :alt: dartwork-mpl Color System
   :srcset: /gallery/08_colors_images/images/sphx_glr_plot_colors_001.png
