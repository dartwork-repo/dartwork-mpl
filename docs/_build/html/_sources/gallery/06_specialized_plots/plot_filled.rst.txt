...
.. "gallery/06_specialized_plots/plot_filled.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_06_specialized_plots_plot_filled.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_06_specialized_plots_plot_filled.py:
...
.. image-sg:: /gallery/06_specialized_plots/images/sphx_glr_plot_filled_001.png
   :alt: Fill Between, Stacked Area Plot, Multiple Filled Regions, Layered Bands with Baseline
   :srcset: /gallery/06_specialized_plots/images/sphx_glr_plot_filled_001.png
