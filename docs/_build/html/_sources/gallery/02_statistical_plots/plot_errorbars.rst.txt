...
.. "gallery/02_statistical_plots/plot_errorbars.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_02_statistical_plots_plot_errorbars.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_02_statistical_plots_plot_errorbars.py:
...
.. image-sg:: /gallery/02_statistical_plots/images/sphx_glr_plot_errorbars_001.png
   :alt: Vertical Error Bars, Horizontal Error Bars, Asymmetric Error Bars, Horizontal Error (log scale)
   :srcset: /gallery/02_statistical_plots/images/sphx_glr_plot_errorbars_001.png
