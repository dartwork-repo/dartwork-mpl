...
.. "gallery/08_colors_images/plot_color_perception.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_08_colors_images_plot_color_perception.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_08_colors_images_plot_color_perception.py:
