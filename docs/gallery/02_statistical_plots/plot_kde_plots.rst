...
.. "gallery/02_statistical_plots/plot_kde_plots.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_02_statistical_plots_plot_kde_plots.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_02_statistical_plots_plot_kde_plots.py:
