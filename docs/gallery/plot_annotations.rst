...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_plot_annotations.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_plot_annotations.py:
...
.. image-sg:: /gallery/images/sphx_glr_plot_annotations_001.png
   :alt: Text Annotations, Arrow Annotations, Custom Markers
   :srcset: /gallery/images/sphx_glr_plot_annotations_001.png
