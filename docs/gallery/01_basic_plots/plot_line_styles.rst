...
.. "gallery/01_basic_plots/plot_line_styles.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_01_basic_plots_plot_line_styles.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_01_basic_plots_plot_line_styles.py:
