...
.. "gallery/01_basic_plots/plot_area_plots.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_01_basic_plots_plot_area_plots.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_01_basic_plots_plot_area_plots.py:
