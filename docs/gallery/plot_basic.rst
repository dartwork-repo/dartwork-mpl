...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_plot_basic.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_plot_basic.py:
...
.. image-sg:: /gallery/images/sphx_glr_plot_basic_001.png
   :alt: Basic Sine/Cosine Plot
   :srcset: /gallery/images/sphx_glr_plot_basic_001.png
