...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_plot_subplots.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_plot_subplots.py:
...
.. image-sg:: /gallery/images/sphx_glr_plot_subplots_001.png
   :alt: Subplot 1, Subplot 2, Subplot 3, Subplot 4
   :srcset: /gallery/images/sphx_glr_plot_subplots_001.png
