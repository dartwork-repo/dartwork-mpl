...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_plot_step.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_plot_step.py:
...
.. image-sg:: /gallery/images/sphx_glr_plot_step_001.png
   :alt: Step: Pre, Step: Post, Multiple Step Series
   :srcset: /gallery/images/sphx_glr_plot_step_001.png
