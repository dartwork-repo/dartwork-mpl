...
.. "gallery/04_scientific_plots/plot_quiver.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_04_scientific_plots_plot_quiver.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_04_scientific_plots_plot_quiver.py:
