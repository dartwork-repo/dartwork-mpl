...
.. "gallery/05_time_series/plot_trend_analysis.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_05_time_series_plot_trend_analysis.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_05_time_series_plot_trend_analysis.py:
