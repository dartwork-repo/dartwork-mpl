...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_plot_image.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_plot_image.py:
...
.. image-sg:: /gallery/images/sphx_glr_plot_image_001.png
   :alt: Colormap: Spectral, Colormap: Coolwarm, Colormap: Viridis
   :srcset: /gallery/images/sphx_glr_plot_image_001.png
