...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_plot_line_advanced.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_plot_line_advanced.py:
...
.. image-sg:: /gallery/images/sphx_glr_plot_line_advanced_001.png
   :alt: Lines with Markers, Line Styles, Error Band
   :srcset: /gallery/images/sphx_glr_plot_line_advanced_001.png
