...
ax1.plot(x, y1, color="dm.red5", lw=0.7, label="Sin(x)")
ax1.plot(x, y2, color="dm.blue5", lw=0.7, label="Sin(x+π/4)")
ax1.plot(x, y3, color="dm.green5", lw=0.7, label="Sin(x+π/2)")
ax1.plot(x, y4, color="dm.orange5", lw=0.7, label="Sin(x+3π/4)")
...
ax2.plot(x, y1, color="dm.red5", lw=0.4, label="LW=0.4")
ax2.plot(x, y2, color="dm.blue5", lw=0.7, label="LW=0.7")
ax2.plot(x, y3, color="dm.green5", lw=1.0, label="LW=1.0")
ax2.plot(x, y4, color="dm.orange5", lw=1.5, label="LW=1.5")
...
ax4.plot(x, y1, color="dm.red2", lw=0.7, label="Red2")
ax4.plot(x, y2, color="dm.red4", lw=0.7, label="Red4")
ax4.plot(x, y3, color="dm.red6", lw=0.7, label="Red6")
ax4.plot(x, y4, color="dm.red8", lw=0.7, label="Red8")
