...
ax1.scatter(x, y_linear, c="dm.blue5", s=5, alpha=0.6, label="Data")
ax1.plot(x, y_fit, color="dm.red5", lw=0.7, label=f"Fit (R²={r_value**2:.3f})")
...
ax2.scatter(x, y_poly, c="dm.green5", s=5, alpha=0.6, label="Data")
ax2.plot(x, y_poly_fit, color="dm.red5", lw=0.7, label="2nd order fit")
...
ax3.scatter(y_fit, residuals, c="dm.blue5", s=5, alpha=0.6)
...
ax4.scatter(x, y_linear, c="dm.blue5", s=5, alpha=0.6, label="Data")
ax4.plot(x, y_fit, color="dm.red5", lw=0.7, label="Fit")
ax4.fill_between(x, y_lower, y_upper, color="dm.red5", alpha=0.2, label="95% CI")
