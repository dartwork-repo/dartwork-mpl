...
gs = fig.add_gridspec(nrows=2, ncols=2, left=0.05, right=0.95,
                      top=0.95, bottom=0.05, wspace=0.25, hspace=0.25)
...
ax2.plot(angles, values1, 'o-', color='dm.blue5', lw=0.7, ms=3, label='Model A')
...
ax3.plot(angles, values1, color='dm.blue5', lw=0.7, label='A')
ax3.plot(angles, values2, color='dm.red5', lw=0.7, label='B')
ax3.plot(angles, values3, color='dm.green5', lw=0.7, label='C')
...
ax4.plot(angles, values1, 'o-', color='dm.purple5', lw=1.0, ms=4)
ax4.fill(angles, values1, color='dm.purple5', alpha=0.3)
