...
axins1 = inset_axes(ax1, width="48%", height="48%", loc='best')
...
axins2 = inset_axes(ax2, width="52%", height="52%", loc='best')
dt = time[1] - time[0]
...
axins3 = inset_axes(ax3, width="44%", height="44%", loc='best')
...
axins4 = inset_axes(ax4, width="48%", height="48%", loc='best')
